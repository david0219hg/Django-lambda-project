    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(choices=[('DOLAR', 'DOLAR'), ('TÍTULO DE PARTICIPACIÓN RENTA VARIABLE', 'TÍTULO DE PARTICIPACIÓN RENTA VARIABLE'), ('TITULO DE PARTICIPACIÓN', 'TITULO DE PARTICIPACIÓN'), ('TIDIS', 'TIDIS'), ('TITULOS HIPOTECARIOS', 'TITULOS HIPOTECARIOS'), ('TES UVR', 'TES UVR'), ('TES TRM', 'TES TRM'), ('TES PESOS', 'TES PESOS'), ('BONOS DEL TESORO EEUU', 'BONOS DEL TESORO EEUU'), ('TES IPC', 'TES IPC')], max_length=50)),
                ('clasification', models.CharField(blank=True, max_length=30, null=True)),
                ('value', models.CharField(max_length=30)),
                ('creation_date', models.DateField()),
                ('expiration_date', models.DateField()),
                ('fee_paid', models.CharField(choices=[('y', 'y'), ('n', 'n')], max_length=20)),
            ],
        ),
    ]
